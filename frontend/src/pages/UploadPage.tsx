...
export default function UploadPage() {
    ...
    const { jsonText, setJsonText, message, loading, onDrop, handleJsonSubmit } = useUpload({
        onComplete: (queueId) => {
    ...
    const dropzone = useDropzone({ onDrop, accept: { 'application/json': ['.json'] } });
        ...
        <div className="flex flex-col gap-6">
            ...
            <Card className="space-y-4 p-0">
                ...
                >
                    ...
                    {dropzone.isDragActive ? 'Drop the JSON file here...' : 'Drag & drop a JSON file here, or click to browse'}
                </div>
